...
from baseformer.tokenization.bpe import BPETokenizer, train_bpe
...
def run_multihead_self_attention(
    ...
    mha.QKV_proj.weights.data = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0) # Linear layer weights are stored as d_out x d_in
    mha.O_proj.weights.data = o_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    mha.QKV_proj.weights.data = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0) # Linear layer weights are stored as d_out x d_in
    mha.O_proj.weights.data = o_proj_weight
    mha.rope = RotaryPositionalEmbedding(theta, d_model//num_heads, max_seq_len)
